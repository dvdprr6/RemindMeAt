...
public class UserImplementation {
    ...
    public void findUserById(final UserCallback userCallback, final String userId) {
        appDatabase.getUserDao().selectById(userId).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<User>() {
            @Override
